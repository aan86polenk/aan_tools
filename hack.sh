...
sleep 1
echo ""
echo  $white"[#]> Mr.polEnk
Here ... "
read enter
exit
}
=================================================
echo $white"Author       : AanpolEnk"
echo $white"Team         : Gandu9 cyber oficiall
echo $white"Thanks To :Mr.M3nt4h | mr.coxI| Mr.toyx | Mr. Anas | "
echo $white"Thanks To :indonesia meme"
echo $white"thanks To : SANTRI CYBER"
echo $white"thanks To : MUSLIM CYBER ARMY"
echo $white"thanks To : Mr.m3nt4h"
...
if [ $bro = 15 ] || [ $bro = 15 ]
then
echo " Thanks To Muslim Cyber army "
sleep 1
echo " Mr.M3nt4h"
sleep 1
echo " da da "
...
echo " Para Hacker"
sleep 1
echo " Jangan Lupa tidur Yahh "
sleep 1
echo " Semoga Lu Besok sehat ea kawan"
sleep 1
exit
fi
